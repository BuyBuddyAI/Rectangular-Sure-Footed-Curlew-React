          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text31">Create an Account</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text32">
                      Sign up for a user account to access all features and save
                      your preferences.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text25">Browse Products</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text27">
                      Explore a wide range of products from various affiliate
                      markets using our search and filters.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Add to Wishlist</span>
                  </Fragment>
                )}
              </h2>
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text26">Place Orders</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text29">
                      Once you find the products you love, click &apos;Buy&apos;
                      to be redirected to the source site for purchase.
                    </span>
                  </Fragment>
                )}
              </span>
