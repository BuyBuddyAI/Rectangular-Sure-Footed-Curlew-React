        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link2Url} className="thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text23">/products</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              <span className="thq-body-small thq-link">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text27">/wishlist</span>
                  </Fragment>
                )}
              </span>
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text21">Login / Register</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text14">Logout</span>
                  </Fragment>
                )}
              </span>
            </button>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text24">Products</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text15">
                                  Explore a wide range of products from various
                                  markets
                                </span>
                              </Fragment>
                            )}
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text16">Profile</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text20">Wishlist</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1624176195342-19344221ca1c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzI4NDY3OHw&ixlib=rb-4.1.0&q=80&w=1080',
  page3: undefined,
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1670101419599-03f917d6c0ce?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzI4NDY3OHw&ixlib=rb-4.1.0&q=80&w=1080',
  page1: undefined,
  logoAlt: 'Site Logo',
  linkUrlPage3: 'https://www.teleporthq.io',
  link3Url: 'https://www.teleporthq.io',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1669236392160-74bba8ac32cd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzI4NDY3N3w&ixlib=rb-4.1.0&q=80&w=1080',
  page4ImageAlt: 'Wishlist Image',
  link4: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1705904506562-f28266845273?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzI4NDY3N3w&ixlib=rb-4.1.0&q=80&w=1080',
}
